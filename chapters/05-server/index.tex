...
El servicio de Python, es una API implementada con Flask [documentacion de flask], este servicio recibe una foto grafia y la procesa utilizando el algoritmo de OCR descripto en el capítulo 2.
