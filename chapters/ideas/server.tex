...
Ademas los clientes pueden configurar las barreras de manera atravez de la plataforma web, los parametros de configuración [deben haber sido nombrados en la sección del algoritmo de la barrera]. Falta agregar imagenes del servicio web, donde sea posible visualizar las distintas vistas que posee la misma.
