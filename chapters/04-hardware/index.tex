...
Adicionalmente se diseñó una tapa rectangular que permita sellar el contenedor. En la Fig. \ref{fig:contenedor-camara} se observa el modelo 3D del sistema, mientras que en la Fig. \ref{fig:contenedor-impreso} se ve el contenedor ensamblado y montado sobre un trípode.
