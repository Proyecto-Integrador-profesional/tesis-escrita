...
\begin{figure}[h]
    ...
    \caption{Comparacion neurona biologica con neurona artificial.}
...
La sinapsis entre neuronas es una suma poderada que puede ser expresada como $y =W^T \cdot X + b$ donde $y$ es el valor de salida de la neurona,
...
luego de que la información es procesada por la neurona, obteniendo $y= f(W^T X + b)$, las funciones de activación más conocidan se pueden observar en la Fig. \ref{fig:funciones-activacion}.
