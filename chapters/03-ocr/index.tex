...
Con la finalidad de dimensionar los tiempos de procesamiento del algoritmo de OCR se procesaron 10 imagenes luego se calculo el promedio para obtener el tiempo promedio por imagen en diferentes sistemas dando los resultados de la Tab. \ref{tab:ocr}.
Luego de analizar los tiempos obtenidos se observa que la Raspberry Pi tarda demasiado en procesar una imagen, mientas que los otros sistemas poseen tiempo similares.
\begin{table}
    \centering
    \begin{tabular}{ccccc}
        \toprule
                   & Raspberry Pi 3b+ & NVIDIA Jetson TX1 & Intel i5-11600K & Inter i5-1135G7 \\
        \midrule
        Tiempo [s] & 85.78            & 6.15              & 1.05            & 1.20            \\
        \bottomrule
    \end{tabular}
    \caption{Tiempos obtenidos del procesamiento de 10 imágenes.}
    \label{tab:ocr}
\end{table}
