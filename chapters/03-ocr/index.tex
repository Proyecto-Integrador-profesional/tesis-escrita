...
Para redimensionar la imagen se utiliza un algoritmo de interpolación bilineal la cual no se explicará debido a que su complejidad este fuera del alcance de este trabajo.
