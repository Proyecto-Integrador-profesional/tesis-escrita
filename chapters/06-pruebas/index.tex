...
En cambio cuando las condiciones de prueba no son las planteadas para esta aplicación, la eficiencia del sistema ronda el $49\%$, esto se puede observar en la prueba de exterior donde no se puede garantizar que los autos se encuentren detenidos, ni en el rango de distancia y ángulo utilizados en la prueba anterior. Se esperaría que si las condiciones de obtención de la imagen se acercaran al ideal de trabajo, aun cuando los vehículos tengan movimiento el porcentaje de acierto aumentaría considerablemente.

En base a estas pruebas se define que las condiciones de trabajo son:
\begin{enumerate}
    \item Distancia entre 50cm y 3m.
    \item Angulo entre $-60^\circ$ y $60^\circ$ 
    \item Velocidad de circulación 10km/h
\end{enumerate}
